...
class AdaPayCommon extends AdaPay {
    function packageRequestUrl($requestParams = array()): string {
     ...
     */
    public function requestAdapay(array $params = array(), string $merchantKey = ""): void {
     ...
     */
    public function requestAdapayUits(array $params = array(), string $merchantKey = ""): void {
